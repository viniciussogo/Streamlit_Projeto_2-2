...
def main():
    ...
    if data_file_1 is not None:
        ...
        st.write(df_RFV['Cluster'].value_counts().sort_index())

        # Visualização dos clusters (média por grupo)
        st.subheader('Média de RFV por Cluster')
